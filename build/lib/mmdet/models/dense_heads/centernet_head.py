...
from mmdet.models.utils import gaussian_radius, gen_gaussian_target   #椭圆高斯
#from mmdet.models.utils.truncate_gaussian import draw_truncate_gaussian
    ...
    def get_targets(self, gt_bboxes, gt_labels, feat_shape, img_shape):
        ...
        for batch_id in range(bs):#一张特征图有多个batch
            ...
            for j, ct in enumerate(gt_centers):
                ...
                radius = gaussian_radius([scale_box_h, scale_box_w],  # 获得每一个标签点的高斯圆半径
                                         min_overlap=0.3)
                radius = max(0, int(radius))
                gen_gaussian_target(center_heatmap_target[batch_id, ind],
                                    [ctx_int, cty_int], radius)#选取一个中心点，在heatmap_targat以一个半径形成高斯圆分布
