...
def main():
    ...
    for i in range(0,len(dataset)):
      data_info = dataset.prepare_train_img(i)
      img = data_info['img']
      gt_bboxs = data_info['gt_bboxes']
      gt_labels = data_info['gt_labels']
      img_name = data_info['img_info']['file_name']
      if img_name=='001149.jpg':
          imshow_det_bboxes(img, gt_bboxs, gt_labels, out_file='inference/gts/' + img_name)
