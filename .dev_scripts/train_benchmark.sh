...
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 ./tools/slurm_train.sh openmmlab atss_r50_fpn configs/atss/atss_r50_fpn.py ./tools/work_dir/atss_r50_fpn --cfg-options checkpoint_config.max_keep_ckpts=1 >/dev/null &
...
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 ./tools/slurm_train.sh openmmlab centernet_resnet18 configs/centernet/mobileneck_resnet50.py ./tools/work_dir/centernet_resnet18 --cfg-options checkpoint_config.max_keep_ckpts=1 >/dev/null &
...
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 ./tools/slurm_train.sh openmmlab yolov3_d53 configs/yolo/yolov3_d53.py ./tools/work_dir/yolov3_d53 --cfg-options checkpoint_config.max_keep_ckpts=1 >/dev/null &
