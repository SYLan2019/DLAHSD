...
echo 'configs/atss/atss_r50_fpn.py' &
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 tools/slurm_test.sh $PARTITION atss_r50_fpn configs/atss/atss_r50_fpn.py $CHECKPOINT_DIR/atss_r50_fpn_1x_coco_20200209-985f7bd0.pth --work-dir tools/batch_test/atss_r50_fpn --eval bbox --cfg-option dist_params.port=29666  &
...
echo 'configs/yolo/yolov3_d53.py' &
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 tools/slurm_test.sh $PARTITION yolov3_d53 configs/yolo/yolov3_d53.py $CHECKPOINT_DIR/yolov3_d53-421362b6.pth --work-dir tools/batch_test/yolov3_d53 --eval bbox --cfg-option dist_params.port=29719  &
...
echo 'configs/centernet/mobileneck_resnet50.py' &
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 tools/slurm_test.sh $PARTITION centernet_resnet18 configs/centernet/mobileneck_resnet50.py $CHECKPOINT_DIR/centernet_resnet18_dcnv2_140e_coco_20210702_155131-c8cd631f.pth --work-dir tools/batch_test/centernet_resnet18 --eval bbox --cfg-option dist_params.port=29721  &
